...
- Po usunięciu efektu trudności zadań, rodzaj otrzymanego zadania (matematyka, czytanie, nauki przyrodnicze) na poszczególnych pozycjach nie wpływa na średni czas poświęcony na rozwiązanie. Na zadania z pierwszej i trzeciej pozycji uczniowie poświęcają średnio więcej czasu niż na zadania znajdujące się na pozycjach drugiej i czwartej. [7]
...
W nawiasie podano jaki typ zadań występował na pozycjach (1,2,3,4) w danych grupach bookletów, przy czym M-zadania matematyczne, R-czytanie, S-nauki przyrodnicze.
...
Badamy czy typ zadań (M,S,R) w booklecie ma wpływ na profil czasu odpowiedzi. Chcemy przy tym uwzględnić, że każdy z typu zadań ma inny poziom trudności.

W każdej grupie bookletów, w każdym booklecie dzielimy czas, jaki uczeń przeznaczył na dane zadanie,
przez średni czas rozwiązań uzyskany na dwóch pozycjach, na których występują zadania tego samego typu
...
i czy zadanie było rozwiązywane dłużej niż średnio dla tego typu w danej grupie bookletów.
...
Komentarz do wykresu: typ otrzymanych zadań nie wpływa na profil odpowiedzi. Najwięcej czasu uczniowie poświęcają na rozwiązania zadań na początku testu/po przerwie, później rozwiązują zadania coraz szybciej.
